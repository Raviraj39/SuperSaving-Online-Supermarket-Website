...
<div style="color: black; text-align: center; font-size: 30px;" class="mt-5 mb-5">About Us <i class='fab fa-elementor'></i></div>
<div class="container my-5">
    ...
    <div class="col-12 col-md-6 d-flex justify-content-center">
        <img src="./images/illustrations/about.jpg" alt="" class="img-fluid w-100 h-100" />
    </div>
    </div>
    </div>
